...
public class TodoWS {
	...
	@Operation(operationId = "addTodo", summary = "Ajoute une nouvelle Todo.", description = "Ajoute une nouvelle Todo.")
	@ApiResponses(value = {
			@ApiResponse(responseCode = "200", description = "OK.", content = @Content(mediaType = "application/json", schema = @Schema(implementation = DetailedTodo.class))),
			@ApiResponse(responseCode = "400", description = "Bad request."),
			@ApiResponse(responseCode = "500", description = "Erreur interne.") })
    public void addTodo(@RequestBody @Valid DetailedTodo todo) {
